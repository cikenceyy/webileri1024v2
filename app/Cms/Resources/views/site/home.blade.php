...
@push('critical-css')
    <style>
        .home-hero{display:grid;gap:clamp(var(--space-24),5vw,var(--space-40));align-items:center;padding-block:clamp(3.5rem,6vw,6.5rem)}
...
@section('content')
    ...
    <section class="pattern-industries" data-module="reveal">
        <div class="section-head stack-sm">
    ...
    <section class="pattern-process" data-module="reveal">
        <div class="section-head stack-sm">
    ...
    <section class="pattern-stats" data-module="reveal">
        <div class="section-head stack-sm">
            ...
            @forelse($featuredProducts as $product)
                <article class="product-card stack-sm">
                    ...
                    <div class="stack-xs">
                        ...
                        @endphp
                        <a class="btn btn-outline" data-module="beacon" data-beacon-event="mini_product_view" data-beacon-payload="{{ $product['slug'] ?? 'product' }}" href="{{ $productUrl }}">{{ __('cms::site.home.products.cta') }}</a>
                    </div>
                </article>
            @empty
