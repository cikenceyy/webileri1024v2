...
@section('content')
    ...
    <section class="section section--hero" data-module="reveal">
        <div class="container container--wide">
            <div class="pattern-hero corporate-hero">
                <div class="stack-lg">
                    ...
                    @if(!empty($pageHero['cta_link']) && !empty($pageHero['cta_text']))
                        <a class="btn btn-primary" data-module="beacon" data-beacon-event="corporate-cta" data-beacon-payload="hero" href="{{ $pageHero['cta_link'] }}">{{ $pageHero['cta_text'] }}</a>
                    @endif
                </div>
    ...
    <section class="section" data-module="reveal">
        <div class="container">
            <div class="pattern-mission mission-grid">
    ...
    <section class="section" data-module="reveal">
        <div class="container container--wide">
            <div class="pattern-split split-grid">
                <div class="stack-md">
    ...
    <section class="section" data-module="reveal">
        <div class="container">
            <div class="pattern-capabilities">
                <div class="section-head stack-sm">
    ...
    <section class="section" data-module="reveal">
        <div class="container container--wide">
            <div class="pattern-timeline">
                ...
                <div class="timeline" data-module="timeline-observer">
        ...
        <div class="container container--wide">
            <div class="pattern-feature">
                <div class="feature-band stack-sm">
                    ...
                    <a class="btn btn-primary" data-module="beacon" data-beacon-event="corporate-cta" data-beacon-payload="cta-band"
