...
@section('content')
    ...
    <section class="section section--hero" data-module="reveal">
        <div class="container container--wide">
            <div class="pattern-hero catalogs-hero">
                <div class="stack-lg">
                        ...
                        <article class="catalog-card stack-sm" data-year="{{ strtolower($catalog['year'] ?? 'all') }}">
                            ...
                            <div class="stack-xs">
                                ...
                                @if(!empty($catalog['file']))
                                    <a class="btn btn-outline" data-module="beacon" data-beacon-event="catalog-open" data-beacon-payload="catalogs" href="{{ $catalog['file'] }}" target="_blank" rel="noopener">{{ __('cms::site.catalogs.card.cta') }}</a>
                                @else
