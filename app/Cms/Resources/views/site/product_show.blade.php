...
@section('content')
    ...
    <section class="pattern-product-hero" data-module="reveal">
        <div class="product-hero grid">
            <div class="stack-lg">
                ...
                <a class="btn btn-primary" data-module="beacon" data-beacon-event="product_contact" data-beacon-payload="{{ $product['slug'] ?? 'product' }}" href="{{ $pageLocale === 'en' ? route('cms.en.contact') : route('cms.contact') }}">{{ __('cms::site.product_show.cta') }}</a>
            </div>
    ...
    <section class="pattern-bullets" data-module="reveal">
    ...
    <section class="pattern-downloads" data-module="reveal">
        <div class="section-head stack-sm">
        ...
        <div class="downloads-grid">
            @forelse($downloads as $download)
                <a class="download-card stack-xs" data-module="beacon" data-beacon-event="product_download" data-beacon-payload="{{ $download['title'] ?? 'document' }}" href="{{ $download['file'] ?? '#' }}" @if(!empty($download['file'])) target="_blank" rel="noopener" @else aria-disabled="true" @endif>
