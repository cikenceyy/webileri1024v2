...
@section('content')
    ...
    <section class="pattern-hero kvkk-hero" data-module="reveal">
        <div class="stack-lg">
            ...
            <p class="lead">{{ $hero['subtitle'] ?? __('cms::site.kvkk.page_hero.subtitle') }}</p>
        </div>
    </section>

    <section class="pattern-kvkk" data-module="reveal">
        <aside class="kvkk-toc" data-module="reveal">
            <h2 class="kvkk-toc__title">{{ __('cms::site.kvkk.toc.title') }}</h2>
            <ol>
                <li><a href="#summary">{{ __('cms::site.kvkk.sections.summary') }}</a></li>
                <li><a href="#purposes">{{ __('cms::site.kvkk.sections.purposes') }}</a></li>
                <li><a href="#retention">{{ __('cms::site.kvkk.sections.retention') }}</a></li>
                <li><a href="#rights">{{ __('cms::site.kvkk.sections.rights') }}</a></li>
                <li><a href="#contact">{{ __('cms::site.kvkk.sections.contact') }}</a></li>
            </ol>
        </aside>
        <article class="kvkk-content stack-xl" data-module="toc-observer">
            <section id="summary" class="stack-md">
                <h2>{{ __('cms::site.kvkk.summary.heading') }}</h2>
                <p>{{ $summary['intro'] ?? __('cms::site.kvkk.summary.text') }}</p>
            </section>

            <section id="purposes" class="stack-md">
            ...
            <section id="retention" class="stack-md">
            ...
            <section id="rights" class="stack-md">
            ...
            <section id="contact" class="stack-md">
                ...
                @if($attachment)
                    <a class="btn btn-outline" data-module="beacon" data-beacon-event="kvkk_pdf" href="{{ $attachment }}" target="_blank" rel="noopener">{{ __('cms::site.kvkk.download') }}</a>
                @else
                    <span class="btn btn-outline is-disabled">{{ __('cms::site.kvkk.download_placeholder') }}</span>
                @endif
            </section>
        </article>
    </section>
