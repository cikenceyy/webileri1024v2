...
@section('content')
    ...
    <section class="section section--hero" data-module="reveal">
        <div class="container container--narrow">
            <div class="pattern-hero kvkk-hero">
                <div class="stack-lg">
            ...
            <div class="pattern-kvkk">
                ...
                <article id="kvkk-content" class="kvkk-content stack-xl">
                    ...
                    <section id="contact" class="stack-md">
                        ...
                        @if($attachment)
                            <a class="btn btn-outline" data-module="beacon" data-beacon-event="kvkk-pdf-open" href="{{ $attachment }}" target="_blank" rel="noopener">{{ __('cms::site.kvkk.download') }}</a>
                        @else
