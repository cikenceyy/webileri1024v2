@php($active = filter_var(old('is_active', $department->is_active ?? true), FILTER_VALIDATE_BOOLEAN))
<div class="row g-3">
    <div class="col-md-4">
        <label class="form-label">Kod</label>
        <input type="text" name="code" value="{{ old('code', $department->code ?? '') }}" class="form-control" maxlength="32" required>
