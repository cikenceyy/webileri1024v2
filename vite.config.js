    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/scss/site/home.scss',
                'resources/scss/site/corporate.scss',
                'resources/scss/site/contact.scss',
                'resources/scss/site/kvkk.scss',
                'resources/scss/site/catalogs.scss',
                'resources/scss/site/products.scss',
                'resources/scss/site/product-show.scss',
                'resources/js/site/home.js',
                'resources/js/site/corporate.js',
                'resources/js/site/contact.js',
                'resources/js/site/kvkk.js',
                'resources/js/site/catalogs.js',
                'resources/js/site/products.js',
                'resources/js/site/product-show.js',
                ...moduleEntries(),
            ],
            refresh: true,
        }),
